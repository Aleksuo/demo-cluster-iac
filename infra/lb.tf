...
resource "hcloud_load_balancer_service" "controlplane_load_balancer_service_gateway_http" {
  load_balancer_id = hcloud_load_balancer.controlplane_load_balancer.id
  protocol         = "tcp"
  listen_port      = 80
...
resource "hcloud_load_balancer_service" "controlplane_load_balancer_service_gateway_https" {
  load_balancer_id = hcloud_load_balancer.controlplane_load_balancer.id
  protocol         = "tcp"
  listen_port      = 443
